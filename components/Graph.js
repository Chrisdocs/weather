    ...
    if (data.hourly && data.hourly.length > 0) {
      ...
      setGraphLabels([
        ...
        moment.unix(data.hourly[8].dt).format("h a"),
				moment.unix(data.hourly[9].dt).format("h a"),
				moment.unix(data.hourly[10].dt).format("h a"),
				moment.unix(data.hourly[11].dt).format("h a"),
				moment.unix(data.hourly[12].dt).format("h a"),
				moment.unix(data.hourly[13].dt).format("h a"),
				moment.unix(data.hourly[14].dt).format("h a"),
				moment.unix(data.hourly[15].dt).format("h a"),
				moment.unix(data.hourly[16].dt).format("h a"),
				moment.unix(data.hourly[17].dt).format("h a"),
				moment.unix(data.hourly[18].dt).format("h a"),
				moment.unix(data.hourly[19].dt).format("h a"),
				moment.unix(data.hourly[20].dt).format("h a"),
				moment.unix(data.hourly[21].dt).format("h a"),
				moment.unix(data.hourly[22].dt).format("h a"),
				moment.unix(data.hourly[23].dt).format("h a"),
      ]);
  ...
  if (isData === true) {
    return (
      <div className={styles.graphContainer}>
        <p className={styles.graphLabel}>24 Hour Weather</p>
        {/* <div className={styles.sliderParent}>
          <input
            ...
            onChange={({ target: { value: radius } }) => {
              setGraphHours(radius);
            }}
          />
        </div> */}
        {/* <div className={styles.bubble}>{graphHours}</div> */}
